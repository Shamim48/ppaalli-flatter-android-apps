...
class GroupOrderDetailsResponse {
  ...
  List<GroupOrderDetailsData> _data;
  ...
  GroupOrderDetailsResponse(
      {bool success,
        ...
        List<GroupOrderDetailsData> data}) {
  ...
  List<GroupOrderDetailsData> get data => _data;
  set data(List<GroupOrderDetailsData> data) => _data = data;
  ...
  GroupOrderDetailsResponse.fromJson(Map<String, dynamic> json) {
    ...
    _groupProductInfo = json['groupProductInfo'] != null
        ...
        : null;
    if (json['data'] != null) {
      _data = new List<GroupOrderDetailsData>();
      json['data'].forEach((v) {
        _data.add(new GroupOrderDetailsData.fromJson(v));
      });
    }
  }
...
class GroupOrderDetailsData {
  int _id;
  String _name;
  String _paymentStatus;
  Null _productId;

  GroupOrderDetailsData({int id, String name, String paymentStatus, Null productId}) {
    this._id = id;
    this._name = name;
  ...
  GroupOrderDetailsData.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    _name = json['name'];
